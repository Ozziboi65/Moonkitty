...
public class EspMenu extends Screen {
    ...
    protected void init() {
        ...
        SliderWidget colorRSlider = new SliderWidget(centerX - 100, centerY - 60, 200, 20, Text.literal("Red: "),
            ...
            protected void applyValue() {
                ...
                Espfeature.setPlayerColor(colorRGB);
            }
        };

        SliderWidget colorGSlider = new SliderWidget(centerX - 100, centerY - 30, 200, 20, Text.literal("Green: "),
        ...
        SliderWidget colorBSlider = new SliderWidget(centerX - 100, centerY + 0, 200, 20, Text.literal("Blue: "),
